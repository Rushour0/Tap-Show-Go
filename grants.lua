...
function scene:create( event )
	...
	local bkgimg = display.newImageRect("img/permission.jpg", system.ResourceDirectory, display.contentWidth, display.contentHeight)
	bkgimg.x = display.contentCenterX
	bkgimg.y = display.contentCenterY

	-- headText 
	local headText = display.newText( "Permissions", display.contentCenterX, display.contentHeight/9 , default_font_bold )
	headText.size = 28
